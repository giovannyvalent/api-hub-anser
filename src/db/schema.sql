...
create table if not exists public.nibo_accounts (
  ...
  bank_account_verification_number integer,
  open_balance  numeric(14,2) default 0,
  date_of_open_balance date,
  is_virtual    boolean not null default false,
  is_reconcilable boolean not null default true,
  is_archived   boolean not null default false,
  scraping_enabled boolean not null default false,
  has_payment_operation boolean not null default false,
  boleto_enabled boolean not null default false,
  is_automated  boolean not null default false,
  can_be_automated boolean not null default false,
  automation_last_sync_date timestamptz,
  automation_requires_migration boolean not null default false,
  automated_account_open_balance_date date,
  ...
  link_id       text,
  cnab_enabled  boolean not null default false,
...
create table if not exists public.nibo_account_balances (
  ...
  account_verification_number integer,
  is_virtual            boolean not null default false,
  is_reconcilable       boolean not null default true,
  is_pj_waiting_approve boolean not null default false,
  bank_id               text,
  ...
  is_account_automated  boolean not null default false,
  raw                   jsonb not null default '{}'::jsonb,
  synced_at             timestamptz not null default now()
);
...
create table if not exists public.nibo_statement (
  ...
  stakeholder_is_deleted boolean not null default false,
...
create table if not exists public.nibo_schedules (
  ...
  cost_center_value_type integer,
  category_id         text,
  category_name       text default '',
  ...
  recurrence          jsonb,
  has_open_entry_promise boolean not null default false,
  has_entry_promise   boolean not null default false,
  last_entry_promise  jsonb,
  auto_generate_entry_promise boolean not null default false,
  has_invoice         boolean not null default false,
  has_pending_invoice boolean not null default false,
  has_schedule_invoice boolean not null default false,
  custom_attributes   jsonb not null default '{}'::jsonb,
  service_provision_location_type integer,
  auto_generate_nfse_type integer,
  auto_generate_collection_type integer,
